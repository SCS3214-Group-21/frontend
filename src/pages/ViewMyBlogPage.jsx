        ...
        <div>
            ...
            <div className="bg-[#FFF8F5] min-h-screen w-full flex flex-row">
                ...
                <div className="w-[95%] sm:w-[90%] md:w-[80%] px-5 sm:px-10 md:pr-20 md:pl-32 xl:pl-5 xl:pr-16">
                    ...
                    <div className="pb-5">
                        <h1 className='text-custom-primary font-bold text-4xl'>Love in Full Blooms</h1>
                    </div>
                    <div className="pb-5">
                        <div className='w-full bg-white border border-[#FFDBC8] rounded-xl border-b-8 p-8 flex flex-col'>
                            <h1 className='text-black font-semibold text-2xl text-center'>Love in Full Blooms - Navigating the Delicate Petals of Romance</h1>
                            <div className="items-end justify-end flex gap-2 flex-row">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-black hover:bg-custom-secondary hover:text-white w-8 h-8 rounded-full p-1">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-red-700 hover:bg-red-700 hover:text-white w-8 h-8 rounded-full p-1">
                            ...
                            <h2 className="font-semibold p-5 text-black">Published By : <span className="font-normal">Admin</span></h2>
                            <CommentSection />
                        </div>
                    </div>
                </div>
