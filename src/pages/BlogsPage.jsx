...
const renderItems = (currentItems) => (
    // <div className='w-full bg-white border border-[#FFDBC8] rounded-xl border-b-8 p-8 flex flex-row items-center justify-center gap-10 sm:gap-5 flex-wrap'>
        ...
        <div className="flex items-center justify-center h-72 w-60 bg-white p-2">
            <AddCard 
                text={"Create Blog"}
                link={"/createblog"}
            />
        ...
        {currentItems.map((item, index) => (
            <div key={index} className='flex items-center justify-center h-72 w-60 bg-white p-2'>
            <BlogCard 
                img={item.img}
                text={item.text}
                date={item.date}
        ...
        <div>
            ...
            <div className="bg-[#FFF8F5] min-h-screen w-full flex flex-row">
                ...
                <div className="w-[95%] sm:w-[90%] md:w-[80%] px-5 sm:px-10 md:pr-20 md:pl-32 xl:pl-5 xl:pr-16">
                    ...
                    <div className="pb-5">
                        <h1 className='text-custom-primary font-bold text-4xl'>Your Blogs</h1>
                    </div>
                    <div className="pb-5">
                        <div className='w-full bg-white border border-[#FFDBC8] rounded-xl border-b-8 p-8 flex flex-row items-center justify-center gap-10 sm:gap-5 flex-wrap'>
