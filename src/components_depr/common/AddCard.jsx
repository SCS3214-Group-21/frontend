...
function AddCard(props) {
    ...
    return (        
        <Link to={props.link} className="w-full h-full bg-white rounded-lg shadow-md flex flex-col gap-5 items-center justify-center p-4 border border-custom-primary cursor-pointer hover:bg-custom-primary hover:bg-opacity-10 hover:shadow-lg transition duration-300">
