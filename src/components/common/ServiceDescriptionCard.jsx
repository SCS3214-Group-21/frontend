...
function ServiceDescriptionCard(props) {
    const { href, img, alt, name, price, description, starCount } = props;

    return (
        <div className="w-[264px] h-[340px] max-w-sm bg-[#FFFBEB] border border-gray-200 rounded-lg shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
